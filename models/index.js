...
<<<<<<< HEAD
// If changed to config.js file commend above line and uncomment below line.
// const config = require(__dirname + '/../config/config.js')[env];
=======
>>>>>>> 4f5213f110e483cda74f3eb6f823d66489749a53
const db = {};

/* Setting up Sequelize and Connecting to the Database */
let sequelize;
...
/* Gathering all model file in the the program */
...
/* Programmatically establishing all Entity-relationship */
...
/* Aftermath of Database connection process */
console.log('Loaded Database Tables:\n', db);
db.sequelize = sequelize;
db.Sequelize = Sequelize;

/* Application-specific constraint: Preferences */
