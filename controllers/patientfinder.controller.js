    ...
    **/
    try{
        ...
        if(
            ...
            const res = {
                status: 200,
                patientData: await database.sequelize.query(`SELECT patid,sex,race,state,pat_age FROM B ORDER BY state where states = '${request.body.selectedState}';`, {type: QueryTypes.SELECT})
            }
            await deleteTemporaryStorage();
            console.log(res);
            return res;
